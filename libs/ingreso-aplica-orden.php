...
<form name="nuevo_dato" action="" onsubmit="aplicar_orden(); return false">
...
oci_free_statement($consulta04);
    ...
    <tr>
      <td></td>
      <td><input name="ingreso" maxlength="60" size="30" value="aplicar_orden" type="hidden" class="text" ></td>
     </tr>
