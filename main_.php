...
<body>
	...
	<div class="page-full-width cf">
		...
		<ul id="nav" class="fl">
			...
			<li class="v-sep"><a href="#" class="round button dark menu-user image-left">Inicio sesion: <strong><?php echo $_SESSION["idusuario"]; ?></strong></a></li>
