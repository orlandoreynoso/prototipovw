...
<p class="error">Quitar producto de bodega</p>
<h1>&nbsp;</h1>
...
<form name="nuevo_dato" action="" onsubmit="guardar_producto_bodega_quitar(); return false">
...
oci_free_statement($consulta05);
    ...
    <tr>
      <td></td>
      <td><input name="ingreso" maxlength="60" size="30" value="quitar_producto_bodega" type="hidden" class="text" ></td>
     </tr>
